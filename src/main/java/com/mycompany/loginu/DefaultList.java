...
public class DefaultList {
    ...
    /*
      public static void loadBooks() {
        ...
        ProjectU.books.add(b1);
        ProjectU.books.add(b2);
        ProjectU.books.add(b3);
    }*/
     /* 
      public static void cxs(){
          ...
          ProjectU.users.add(us);
          ProjectU.users.add(us1);
          ProjectU.users.add(us2);
     ...
     public static void codp(){
          ...
          pc1.setCutoffDate("30/04/2025");
          
          ProjectU.prco.add(pc);
          ProjectU.prco.add(pc1);
