...
public class BookQuery extends javax.swing.JFrame {
    ...
    private void queryTable() {
        String headers[] = {"Author", "Title", "Price", "Genre", "Quantity in Stock"};

        DefaultTableModel t = new DefaultTableModel(headers, ProjectU.books.size());
        jTable1.setModel(t);

        TableModel tbl = jTable1.getModel();

        for (int i = 0; i < ProjectU.books.size(); i++) {
            Book bo = ProjectU.books.get(i);

            tbl.setValueAt(bo.getAuthor(), i, 0);
            tbl.setValueAt(bo.getTitle(), i, 1);
            tbl.setValueAt(bo.getPrice(), i, 2);
            tbl.setValueAt(bo.getGenre(), i, 3);
            tbl.setValueAt(bo.getStockQuantity(), i, 4);
        }
    ...
    private void updateD() {
        ...
        if (update > -1) {
            ...
            bok = ProjectU.books.get(update);
            jTextField1.setText(bok.getAuthor());
            jTextField2.setText(bok.getTitle());
            jTextField3.setText(String.valueOf(bok.getPrice()));
            jTextField4.setText(bok.getGenre());
            jTextField5.setText(String.valueOf(bok.getStockQuantity()));
    ...
    private void saveChan() {
        if (jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty() || jTextField4.getText().isEmpty() || jTextField5.getText().isEmpty()) {
            ...
            if (bok != null) {
                ...
                bok.setGenre(jTextField4.getText());
                bok.setStockQuantity(Integer.parseInt(jTextField5.getText()));
            } else {
